...
public class EmAltaFragment extends Fragment {
    ...
    List<SneakerCardData> mSneakerListEmAlta;
    ...
    public EmAltaFragment() {
        mSneakerListEmAlta = new ArrayList<>();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_em_alta,container,false);
        ...
        MyAdapter myAdapter = new MyAdapter(getContext(),mSneakerListEmAlta);
        ...
        ValueEventListener messageListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mRecyclerView.setLayoutManager(mGridLayoutManager);
                    mRecyclerView.setAdapter(myAdapter);
                    Log.d("tag",(String.valueOf(mSneakerListEmAlta.size())));
                    Log.d("tag","event");
                }
                else{Log.d("tag","erro");}
